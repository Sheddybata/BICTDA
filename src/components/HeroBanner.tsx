      ...
      <div className="relative z-10 w-full">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-bictda-light mb-8 max-w-2xl">
              Driving digital transformation and technological advancement across Borno State
            </p>
            <Button 
              size="lg" 
              className="bg-bictda-medium text-white hover:bg-bictda-dark font-semibold px-8 py-3 text-lg"
            >
              Learn More
            </Button>
          </div>
